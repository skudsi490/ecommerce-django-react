...
EOF
                            ...
                            scp -o StrictHostKeyChecking=no -i ${SSH_KEY} -r Dockerfile entrypoint.sh backend base frontend manage.py requirements.txt static media data_dump.json pytest.ini nginx.conf ecommerce-django-react.conf ubuntu@${MY_UBUNTU_IP}:/home/ubuntu/
                            '''
